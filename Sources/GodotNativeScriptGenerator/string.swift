func print(bold values:Any..., separator: String = " ", terminator: String = "\n")
{
    print(values.map{ "\($0)" }.joined(separator: separator).bolded, terminator: terminator)
}
func print(note values:Any..., separator: String = " ", terminator: String = "\n")
{
